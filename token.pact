(namespace "free")
(define-keyset "free.merchkeysetaa"  (read-keyset "merchkeysetaa"))
(module afz-coin GOVERNANCE
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset "free.merchkeyset")
  )
  ...
  (defconst INITIAL_SUPPLY:decimal 10000.0
    " 10,000")
